...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<DataDbContext>
{
    public DataDbContext CreateDbContext(string[] args)
    {
        ...
        dbContextOptionsBuilder.UseSqlServer("Server=localhost, 1433;Database=PortfolioProject;User Id=SA;Password=reallyStrongPwd123;TrustServerCertificate=True;");
